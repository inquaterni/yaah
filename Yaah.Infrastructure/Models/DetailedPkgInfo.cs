...
namespace Yaah.Infrastructure.Models;
...
public sealed class DetailedPkgInfo
{
    ...
    [JsonPropertyName("PackageBaseID")] public int PackageBaseId { get; set; }
    ...
    [JsonPropertyName("FirstSubmitted")] public ulong FirstSubmitted { get; set; }

    [JsonPropertyName("LastModified")] public ulong LastModified { get; set; }
