...
public unsafe struct AlpmPkgListNode: IAlpmListNode<AlpmPkgListNode>
{
    ...
    {
        return alpm_pkg_get_name(Data) == alpm_pkg_get_name(other.Data) && Equals(Next, other.Next) && Equals(Prev, other.Prev);
    }

    private static bool Equals(AlpmPkgListNode* self, AlpmPkgListNode* other)
    {
        return alpm_pkg_get_name(self->Data) == alpm_pkg_get_name(other->Data) && Equals(self->Next, other->Next) && Equals(self->Prev, other->Prev);
    }
